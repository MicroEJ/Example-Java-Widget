...
import ej.automaton.AutomatonFactory;

/**
 * Automaton factory for the application.
 */
public class WidgetsAutomatonFactory implements AutomatonFactory<WidgetsAutomaton> {
