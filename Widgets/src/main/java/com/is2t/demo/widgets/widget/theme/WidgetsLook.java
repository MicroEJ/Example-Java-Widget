...
/**
 * Look used by the theme #WidgetsTheme.
 */
public class WidgetsLook implements Look {

	private static final int EMPIRICAL_COEFFICIENT = 2585;
	...
	private static final int FOREGROUND_COLOR_CONTENT = 0x0;
	...
	private static final int X_BIG_FONT_INDEX = 3;

	private static final int BOLD_MEDIUM_FONT_INDEX = 4;
	...
	private static final DisplayFont BIG_FONT = DisplayFont.getFont(DisplayFont.LATIN, getBigFontHeight(),
	...
	private static final DisplayFont BOLD_MEDIUM_FONT = DisplayFont.getFont(DisplayFont.LATIN, 30,
	...
	static {
		FONTS = new DisplayFont[] { SMALL_FONT, MEDIUM_FONT, BIG_FONT, X_BIG_FONT, BOLD_MEDIUM_FONT, SMALL_PICTO_FONT,
				MEDIUM_PICTO_FONT, BIG_PICTO_FONT, };
	}

	private static int getBigFontHeight() {
		Display display = Display.getDefaultDisplay();
		return display.getWidth() * display.getHeight() / EMPIRICAL_COEFFICIENT;
	}
	...
	public int getProperty(int resource) {
		...
		case LookExtension.GET_XXX_SMALL_FONT_INDEX: // fall down
		case LookExtension.GET_XX_SMALL_FONT_INDEX: // fall down
		case LookExtension.GET_X_SMALL_FONT_INDEX: // fall down
		...
		case LookExtension.GET_X_BIG_FONT_INDEX:
			return X_BIG_FONT_INDEX;
		case LookExtension.GET_BOLD_X_SMALL_FONT_INDEX: // fall down
