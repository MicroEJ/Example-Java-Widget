...
public class WidgetsLook implements Look {
	...
	private static final int X_SMALL_PICTO_FONT_INDEX = 5;
	private static final int SMALL_PICTO_FONT_INDEX = 6;
	private static final int MEDIUM_PICTO_FONT_INDEX = 7;
	private static final int BIG_PICTO_FONT_INDEX = 8;
	...
	private static final DisplayFont BIG_FONT = DisplayFont.getFont(DisplayFont.LATIN, getBigFontHeight(), DisplayFont.STYLE_PLAIN);
	...
	static {
		FONTS = new DisplayFont[] { SMALL_FONT, MEDIUM_FONT, BIG_FONT, X_BIG_FONT, BOLD_MEDIUM_FONT, X_SMALL_PICTO_FONT, SMALL_PICTO_FONT, MEDIUM_PICTO_FONT,
				BIG_PICTO_FONT, };
	}
	
	private static int getBigFontHeight() {
		Display display = Display.getDefaultDisplay();
		return display.getWidth() * display.getHeight() / 2585;
	}
