...
public class ButtonImagePathTest extends TestEvent {

	public static void main(String[] args) {
		TestHelper.launchTest(new ButtonImagePathTest());
	}

	@Override
	public void run(Display display) {
		try {
			testOnClickListenerNotifiedNoUI();
			testOnClickListenerNotifiedUI();
			testIsInActiveState();
	...
	protected void testOnClickListenerNotifiedNoUI() {
		ButtonImagePath button = new ButtonImagePath("/images/cowboy.png");
	...
	protected void testOnClickListenerNotifiedUI() {
		ButtonImagePath button = new ButtonImagePath("/images/cowboy.png");
	...
	protected void testIsInActiveState() {
		ButtonImagePath button = new ButtonImagePath("/images/cowboy.png");
