 ...
 *
 */
public class TestShownListCarousel extends Test {

	private static final int DURATION = 200;

	public static void main(String[] args) {
		TestHelper.launchTest(new TestShownListCarousel());
	}
	...
	public void run(Display display) {
		...
		ListCarousel listCarousel = new ListCarousel(LayoutOrientation.VERTICAL, false);
		MyFreeWidget widget1 = new MyFreeWidget(displayWidth, displayHeight);
		MyFreeWidget widget2 = new MyFreeWidget(displayWidth, displayHeight);
		desktop.setWidget(listCarousel);
		listCarousel.addChild(widget1);
		listCarousel.addChild(widget2);
