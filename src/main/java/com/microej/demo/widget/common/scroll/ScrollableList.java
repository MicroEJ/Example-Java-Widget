...
public class ScrollableList extends List implements Scrollable {
	...
	private final boolean snapToItems;
	 ...
	 * @param snapToItems
	 *            {@code true} if the scroll should snap to this list items, {@code false} otherwise.
	 */
	public ScrollableList(boolean orientation, boolean snapToItems) {
		super(orientation);
		this.snapToItems = snapToItems;
	}
